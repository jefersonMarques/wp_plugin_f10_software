...
final class F10LECA_WhatsApp
{
    ...
    public function register_hooks(): void
    {
        ...
        add_action('wp_ajax_f10leca_submit_whatsapp', array($this, 'handle_submission'));
        add_action('wp_ajax_nopriv_f10leca_submit_whatsapp', array($this, 'handle_submission'));
        add_action('wp_ajax_f10leca_track_whatsapp', array($this, 'handle_tracking'));
        add_action('wp_ajax_nopriv_f10leca_track_whatsapp', array($this, 'handle_tracking'));
    }
    ...
    public function enqueue_assets(): void
    {
        ...
        $this->widget = F10LECA_WhatsApp_Config::resolve_current_widget();
        ...
        wp_enqueue_script(
            'f10leca-whatsapp',
            F10LECA_URL . 'assets/js/whatsapp.js',
            array(),
            F10LECA_VERSION,
            true
        );

        $settings = F10LECA_Config::get_settings();
        $schedule_state = F10LECA_WhatsApp_Config::schedule_state($this->widget);
        ...
        wp_localize_script(
            ...
            array(
                ...
                'nonce' => wp_create_nonce('f10leca_whatsapp_submit'),
    ...
    public function render_widget(): void
    {
        ...
        ?>
        <div
            class="f10leca-whatsapp-widget f10leca-whatsapp-widget--<?php echo esc_attr($position); ?> f10leca-whatsapp-widget--<?php echo esc_attr($design); ?>"
            style="--f10leca-whatsapp-color:<?php echo esc_attr($widget['color']); ?>"
            data-f10leca-whatsapp-widget
            data-widget-id="<?php echo esc_attr($widget['id']); ?>"
            hidden
        >
            <button
                type="button"
                class="f10leca-whatsapp-widget__trigger"
                aria-label="Abrir atendimento pelo WhatsApp"
                aria-haspopup="dialog"
                data-f10leca-whatsapp-trigger
            >
                <span class="f10leca-whatsapp-widget__radar" aria-hidden="true"></span>
                <span class="f10leca-whatsapp-widget__icon" aria-hidden="true">
            ...
            <button type="button" class="f10leca-whatsapp-widget__badge" data-f10leca-whatsapp-badge>
                <?php echo esc_html($widget['badge_online']); ?>
            </button>

            <div class="f10leca-whatsapp-widget__overlay" data-f10leca-whatsapp-overlay hidden>
                <section
                    class="f10leca-whatsapp-widget__dialog"
                    role="dialog"
                    aria-modal="true"
                    aria-labelledby="f10leca-whatsapp-title-<?php echo esc_attr($widget['id']); ?>"
                    data-f10leca-whatsapp-dialog
                >
                    <button
                        type="button"
                        class="f10leca-whatsapp-widget__close"
                        aria-label="Fechar"
                        data-f10leca-whatsapp-close
                    >&times;</button>

                    <div class="f10leca-whatsapp-widget__dialog-header">
                        <span class="f10leca-whatsapp-widget__dialog-icon" aria-hidden="true">
                        ...
                        <div>
                            <h2 id="f10leca-whatsapp-title-<?php echo esc_attr($widget['id']); ?>">
                                <?php echo esc_html($widget['form_title']); ?>
                            </h2>
                            <p data-f10leca-whatsapp-description><?php echo esc_html($widget['form_description']); ?></p>
                        </div>
                    </div>

                    <form
                        class="f10leca-whatsapp-widget__form"
                        method="post"
                        action="<?php echo esc_url(admin_url('admin-ajax.php')); ?>"
                        data-f10leca-whatsapp-form
                        novalidate
                    >
                        <input type="hidden" name="action" value="f10leca_submit_whatsapp">
                        <input type="hidden" name="nonce" value="<?php echo esc_attr(wp_create_nonce('f10leca_whatsapp_submit')); ?>">
                        ...
                        <input type="hidden" name="page_url" value="" data-f10leca-whatsapp-page-url>
                        <input type="hidden" name="referrer_url" value="" data-f10leca-whatsapp-referrer-url>
                        <input type="hidden" name="page_title" value="" data-f10leca-whatsapp-page-title>
                        <input type="hidden" name="utm_source" value="" data-f10leca-whatsapp-utm="utm_source">
                        <input type="hidden" name="utm_medium" value="" data-f10leca-whatsapp-utm="utm_medium">
                        <input type="hidden" name="utm_campaign" value="" data-f10leca-whatsapp-utm="utm_campaign">
                        <input type="hidden" name="utm_term" value="" data-f10leca-whatsapp-utm="utm_term">
                        <input type="hidden" name="utm_content" value="" data-f10leca-whatsapp-utm="utm_content">

                        <div class="f10leca-whatsapp-widget__honeypot" aria-hidden="true">
                            <label>
                                Website
                        ...
                        <label class="f10leca-whatsapp-widget__field">
                            <span>Nome</span>
                        ...
                        <label class="f10leca-whatsapp-widget__field">
                            ...
                            <input
                                ...
                                data-f10leca-whatsapp-phone
                                required
                            >
                        </label>

                        <?php if ($settings['require_consent'] === '1') : ?>
                            <label class="f10leca-whatsapp-widget__consent">
                                <input type="checkbox" name="consent" value="1" required>
                                <span><?php echo esc_html((string) $settings['consent_text']); ?></span>
                            </label>
                        <?php endif; ?>

                        <button type="submit" class="f10leca-whatsapp-widget__submit" data-f10leca-whatsapp-submit>
                            <span data-f10leca-whatsapp-submit-label><?php echo esc_html($widget['button_label']); ?></span>
                            <span class="f10leca-whatsapp-widget__spinner" aria-hidden="true"></span>
                        </button>

                        <div
                            class="f10leca-whatsapp-widget__message"
                            role="status"
                            aria-live="polite"
                            data-f10leca-whatsapp-message
                        ></div>
                    </form>
                </section>
            </div>
    ...
    public function handle_submission(): void
    {
        ...
        $schedule_state = F10LECA_WhatsApp_Config::schedule_state($widget);
        ...
        $visitor_whatsapp = F10LECA_WhatsApp_Config::normalize_phone(
        ...
        $message = F10LECA_WhatsApp_Config::build_message(
            $widget,
            array(
                'name' => $name,
        ...
        $whatsapp_url = $should_open
            ? F10LECA_WhatsApp_Config::build_url($widget, $message)
            : '';
        ...
        $result = F10LECA_Submission_Service::submit($lead_data);
        ...
        wp_send_json_success(
            array(
                ...
                'token' => F10LECA_Config::conversion_token((int) $result['lead_id']),
    ...
    public function handle_tracking(): void
    {
        ...
        if (!hash_equals(F10LECA_Config::conversion_token($lead_id), $token)) {
    ...
    {
        if (check_ajax_referer('f10leca_whatsapp_submit', 'nonce', false) === false) {
            wp_send_json_error(
    ...
    {
        $key = 'f10leca_lead_whatsapp_rate_' . substr($this->get_ip_hash(), 0, 32);
