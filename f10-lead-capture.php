...
define('F10_LEAD_CAPTURE_VERSION', '1.3.7');
...
require_once F10_LEAD_CAPTURE_PATH . 'includes/class-f10-lead-capture-whatsapp-config.php';
require_once F10_LEAD_CAPTURE_PATH . 'includes/class-f10-lead-capture-whatsapp-form-mode.php';
...
require_once F10_LEAD_CAPTURE_PATH . 'includes/class-f10-lead-capture-submission-service.php';
require_once F10_LEAD_CAPTURE_PATH . 'includes/class-f10-lead-capture-form.php';
require_once F10_LEAD_CAPTURE_PATH . 'includes/class-f10-lead-capture-whatsapp.php';
